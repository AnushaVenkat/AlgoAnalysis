...
{
	/**
	* Matches the code from the Phonex class and compares it with the code obtained from the database and returns the matched names.
	*
	*Input characters are obtained from the user and is encoded using Phonex Algorithm, All the other names present in the database are encoded using the same Phonex algorithm
	...
	*
	*{@link action.phone.Phonex } extends the Phonex class and HttpServlet class
	*/ 
