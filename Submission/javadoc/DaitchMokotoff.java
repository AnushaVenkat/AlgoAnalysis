...
public class DaitchMokotoff
{
	...
	int j=0,flag=1;
	/**
	* Encoding the words using Daitch Mokootof Algorithm
	*
	*Input characters are obtained from the user and is encoded using Daitch Mokootof Algorithm and the codes are passed on to the servlet pages for comparison and retrival.
	*
	*@param	a,b,c - letters from the user is obtained 
	*
	*
	*return code- returns the code that is used to match the code in the database
	*
	...
	*
	*@param	a,c - letters from the user is obtained 
	*
	*
	*return code- returns the code that is used to match the code in the database
	*
	...
	*Both the codes are compared and the matching names are displayed
	*
	*@param	inputname - letters from the user is obtained 
	*
	*
	*return code- returns the code that is used to match the code in the database
	*
